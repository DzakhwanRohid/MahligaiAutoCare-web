    ...
    <div style="max-height: 80vh; overflow-y: auto; padding-right: 10px;">
        ...
        <form method="POST" action="{{ route('register') }}" class="auth-form">
            ...
            <div class="form-group mb-3">
                ...
                <input id="phone" class="form-control" type="text" name="phone" :value="old('phone')" required placeholder="081234567890" />
            ...
            <div class="row g-2 mb-3">
                <div class="col-md-6">
                    ...
                    <input id="license_plate" class="form-control text-uppercase" type="text" name="license_plate" :value="old('license_plate')" placeholder="BM 1234 AB" />
                ...
                <div class="col-md-6">
                    ...
                    <input id="vehicle_type" class="form-control" type="text" name="vehicle_type" :value="old('vehicle_type')" placeholder="Cth: Avanza Hitam" />
            ...
            <div class="form-group mb-4">
                ...
                <input id="password_confirmation" class="form-control" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password Anda" />
