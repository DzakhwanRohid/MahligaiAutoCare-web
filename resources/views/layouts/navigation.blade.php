                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('pos.index')"> {{ __('Kasir (POS)') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('transaksi.antrean')"> {{ __('Antrean Real-time') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('transaksi.riwayat')"> {{ __('Riwayat Transaksi') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('layanan.index')"> {{ __('Layanan & Harga') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('promosi.index')"> {{ __('Diskon & Promosi') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('users.index')"> {{ __('Manajemen User (Karyawan)') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('customer.index')"> {{ __('Data Pelanggan') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('laporan.pemesanan')"> {{ __('Laporan Pemesanan') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('laporan.pendapatan')"> {{ __('Laporan Pendapatan') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    @if(Auth::user()->role == 'admin')
                    <x-nav-link :href="route('pengaturan.index')" :active="request()->routeIs('pengaturan.index')"> {{ __('Pengaturan') }}
                    </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('layanan.index')">
                        {{ __('Layanan & Harga') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('promosi.index')">
                        {{ __('Diskon & Promosi') }}
                    </x-responsive-nav-link>
                </div>
            </div>
...
</nav><nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
